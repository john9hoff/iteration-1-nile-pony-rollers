...
describe('Resources list service: ', () => {
    ...
    const testGoals: resources[] = [
        {
            resourceName: 'food_id',
            resourceBody: 'Gain some weight',
            resourcePhone: 'Food',
            resourcesUrl: 'Eat all the cookies',
        },
        {
            resourceName: 'chores_id',
            resourceBody: 'Have cleaner kitchen',
            resourcePhone: 'Chores',
            resourcesUrl: 'Take out recycling',
        },
        {
            resourceName: 'family_id',
            resourceBody: 'To love her',
            resourcePhone: 'Family',
            resourcesUrl: 'Call mom',
        }
    ];
    const mGoals: resources[] = testGoals.filter(Resource =>
